...
Målgrupp: 
Privata personer eller företag som vill se och övervaka sin energiförbrukning. Det är ett enkelt sätt att se hur mycket energi som används och hitta möjligheter att spara energi.
...
Backend hanterar data med Spring Boot.

Planering:

Vecka 1–2: Planering och design.

Vecka 3–5: Koda frontend och backend.

Vecka 6: Testning och rapport.

Jag använder GitHub för att spara kod och planera arbetet.

Teknik: 

HTML, CSS, JavaScript, React, Java och Spring Boot och Github
